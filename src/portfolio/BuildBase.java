...
public class BuildBase extends AbstractionLayerAI {
	...
	// BuildBase: build a new base close to another resources area

	public BuildBase(UnitTypeTable a_utt) {
		this(a_utt, new AStarPathFinding());
	}

	public BuildBase(UnitTypeTable a_utt, PathFinding a_pf) {
		super(a_pf);
		utt = a_utt;
